...
#define LATITUDE_MINUTES_LENGTH 8
#define LATITUDE_SECONDS_LENGTH 0
#define LONGITUDE_DEGREES_LENGTH 3
#define LONGITUDE_MINUTES_LENGTH 8
#define LONGITUDE_SECONDS_LENGTH 0
